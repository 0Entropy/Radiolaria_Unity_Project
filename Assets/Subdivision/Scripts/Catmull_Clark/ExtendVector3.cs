...
static class ExtendVector3
{
    public static Vector3 AverageVector3(this IEnumerable<Vector3> vectors)
    {
        return
            new Vector3(
...
/*
    public static Vector3 AverageVector3(this Vector3[] vectors)
    {
        return
            new Vector3(
                vectors.Average(v => v.x),
    ...
    public static Subdivision.Core.Point AverageVector3(this IEnumerable<Subdivision.Core.Point> points)
    {
        return
            new Subdivision.Core.Point(points.Select(p => p.Position).AverageVector3());
    }

    public static Vector3 CrossProduct(this Vector3 one, Vector3 other)
    {
        return
            new Vector3(
