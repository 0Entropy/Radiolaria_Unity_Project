...
//		Undo.RegisterSceneUndo("PolyMesh Changed");//
		Undo.RegisterCreatedObjectUndo(target, "PolyMesh Changed");//
#endif
	...
	protected static void CreatePolyMesh()
	{
	...
	protected static void CreateSquare(PolyMesh polyMesh, float size)
	{
