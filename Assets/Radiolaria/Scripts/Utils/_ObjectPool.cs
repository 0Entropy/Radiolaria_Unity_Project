...
public sealed class _ObjectPool : MonoBehaviour
{
	private static _ObjectPool _instance;
	...
	public static _ObjectPool instance
	{
		get
		{
			...
			_instance = obj.AddComponent<_ObjectPool>();
			return _instance;
		}
	}
}

public static class _ObjectPoolExtensions
{
	public static void CreatePool<T>(this T prefab) where T : Component
	{
		_ObjectPool.CreatePool(prefab);
	}
	
	public static T Spawn<T>(this T prefab, Vector3 position, Quaternion rotation) where T : Component
	{
		return _ObjectPool.Spawn(prefab, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Vector3 position) where T : Component
	{
		return _ObjectPool.Spawn(prefab, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab) where T : Component
	{
		return _ObjectPool.Spawn(prefab, Vector3.zero, Quaternion.identity);
	}
	...
	public static int Count<T>(T prefab) where T : Component
	{
		return _ObjectPool.Count(prefab);
	}
}
